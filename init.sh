...
#supervisord config
supervisord_script=$(wget -O- https://raw.githubusercontent.com/a1991815a/breakwall/master/supervisord.conf | sed "s/%username%/$supervisord_username/g" | sed "s/%password%/$supervisord_passwd/g" | sed "s/%shadowsocks_bin%/$shadowsocks_bin/g" | sed "s/%kcptun_bin%/$kcptun_bin/g")
